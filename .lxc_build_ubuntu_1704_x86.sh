...
lxc file pull ${CONTAINER}/tmp/work/build/build_lua5.1_ubuntu_1704_x86.tar.gz build/
lxc file pull ${CONTAINER}/tmp/work/build/build_lua5.2_ubuntu_1704_x86.tar.gz build/
lxc file pull ${CONTAINER}/tmp/work/build/build_lua5.3_ubuntu_1704_x86.tar.gz build/
