...
lxc exec ${CONTAINER} -- bash -c 'chown -R `stat -c %u:%g /tmp/work` /tmp/work/build/windows32'
...
lxc exec ${CONTAINER} -- bash -c 'chown -R `stat -c %u:%g /tmp/work` /tmp/work/build/windows64'
