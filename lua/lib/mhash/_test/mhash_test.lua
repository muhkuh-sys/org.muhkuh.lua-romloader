...
local function hash_show_error(input, hash, expected)
...
local function check_hash(hash_id, patterns)
	-- expect success
	fResult = true
...
print("Found mhash version '" .. mhash.get_version() .. "'")

-- print some info
hash_cnt = mhash.count()
print( string.format("this version of mhash knows %d hash types.", hash_cnt) )
for t=0,hash_cnt do
	name = mhash.get_hash_name(t)
	if name then
		print( string.format("\t%d: %s (%d)", t, name, mhash.get_block_size(t)) )
	end
end
...
expected_hash = string.char(0x33, 0xF0, 0xC4, 0x68)
...
if check_hash(mhash.MHASH_CRC32, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_CRC32B, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_MD2, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_MD4, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_MD5, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_HAVAL256, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_HAVAL224, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_HAVAL192, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_HAVAL160, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_HAVAL128, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_RIPEMD128, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_RIPEMD160, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_RIPEMD256, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_RIPEMD320, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_TIGER192, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_TIGER160, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_TIGER128, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_GOST, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_SHA1, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_SHA256, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_SHA224, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_SHA512, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_SHA384, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_WHIRLPOOL, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_SNEFRU128, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
...
if check_hash(mhash.MHASH_SNEFRU256, hash_check) then
	print "Ok!"
else
	error("Test failed!")
end
