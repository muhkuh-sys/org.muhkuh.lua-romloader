...
if strDistId=='windows' then
  if strCpuArch=='x86' then
    ...
    t:install('windows_x86/lua_plugins/openocd.dll',                         '${install_lua_cpath}/')
  ...
  elseif strCpuArch=='x86_64' then
    ...
    t:install('windows_x86_64/lua_plugins/openocd.dll',                      '${install_lua_cpath}/')
...
elseif strDistId=='ubuntu' then
  if strDistVersion=='14.04' then
    if strCpuArch=='x86' then
      ...
      t:install('ubuntu_1404_x86/lua_plugins/openocd.so',                    '${install_lua_cpath}/')
    ...
    elseif strCpuArch=='x86_64' then
      ...
      t:install('ubuntu_1404_x86_64/lua_plugins/openocd.so',                 '${install_lua_cpath}/')
  ...
  elseif strDistVersion=='16.04' then
    if strCpuArch=='x86' then
      ...
      t:install('ubuntu_1604_x86/lua_plugins/openocd.so',                    '${install_lua_cpath}/')
    ...
    elseif strCpuArch=='x86_64' then
      ...
      t:install('ubuntu_1604_x86_64/lua_plugins/openocd.so',                 '${install_lua_cpath}/')
  ...
  elseif strDistVersion=='17.04' then
    if strCpuArch=='x86' then
      ...
      t:install('ubuntu_1704_x86/lua_plugins/openocd.so',                    '${install_lua_cpath}/')
    ...
    elseif strCpuArch=='x86_64' then
      ...
      t:install('ubuntu_1704_x86_64/lua_plugins/openocd.so',                 '${install_lua_cpath}/')
