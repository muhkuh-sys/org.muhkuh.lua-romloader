...
# PROP Target_Dir ""
# ADD BASE CPP /nologo /FD /MD /W1 /GR /EHsc /I "$(WXWIN)\lib\vc_dll\msw" /I "$(WXWIN)\include" /O2 /I "..\..\modules" /I ".\..\.." /I "..\..\..\modules\lua\include" /Fd..\..\bin\openocd.pdb /I "..\..\plugins\romloader\openocd" /I "..\..\plugins\romloader\openocd\openocd" /I "..\..\plugins\romloader\openocd\openocd\helper" /I "..\..\plugins\romloader\openocd\openocd\jtag" /I "..\..\plugins\romloader\openocd\openocd\target" /I "..\..\plugins\romloader\openocd\openocd\xsvf" /I "..\..\plugins\romloader\openocd\openocd\win\include" /D "WIN32" /D "_USRDLL" /D "DLL_EXPORTS" /D "WXUSINGDLL" /D "__WXMSW__" /D "HAVE_CONFIG_H" /D PKGLIBDIR=\".\" /c
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo /FD /MDd /W1 /GR /EHsc /I "$(WXWIN)\lib\vc_dll\mswd" /I "$(WXWIN)\include" /Od /Gm /I "..\..\modules" /I ".\..\.." /I "..\..\..\modules\lua\include" /Zi /Fd..\..\bin\openocd.pdb /I "..\..\plugins\romloader\openocd" /I "..\..\plugins\romloader\openocd\openocd" /I "..\..\plugins\romloader\openocd\openocd\helper" /I "..\..\plugins\romloader\openocd\openocd\jtag" /I "..\..\plugins\romloader\openocd\openocd\target" /I "..\..\plugins\romloader\openocd\openocd\xsvf" /I "..\..\plugins\romloader\openocd\openocd\win\include" /D "WIN32" /D "_USRDLL" /D "DLL_EXPORTS" /D "WXUSINGDLL" /D "__WXDEBUG__" /D "__WXMSW__" /D "_DEBUG" /D "HAVE_CONFIG_H" /D PKGLIBDIR=\".\" /c
