...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_lua5.1_ubuntu_1604_x86_64.tar.gz --gzip --directory /tmp/work/build/linux/lua5.1/install .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_lua5.2_ubuntu_1604_x86_64.tar.gz --gzip --directory /tmp/work/build/linux/lua5.2/install .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_lua5.3_ubuntu_1604_x86_64.tar.gz --gzip --directory /tmp/work/build/linux/lua5.3/install .'
lxc exec ${CONTAINER} -- bash -c 'chown -R `stat -c %u:%g /tmp/work` /tmp/work/build/linux'
lxc exec ${CONTAINER} -- bash -c 'chown `stat -c %u:%g /tmp/work` /tmp/work/build/build_lua5.1_ubuntu_1604_x86_64.tar.gz'
lxc exec ${CONTAINER} -- bash -c 'chown `stat -c %u:%g /tmp/work` /tmp/work/build/build_lua5.2_ubuntu_1604_x86_64.tar.gz'
lxc exec ${CONTAINER} -- bash -c 'chown `stat -c %u:%g /tmp/work` /tmp/work/build/build_lua5.3_ubuntu_1604_x86_64.tar.gz'
