...
`Source: "bin\lua_hilscher\detect_netx.lua"; DestDir: "{app}\application\lua_hilscher"; Components: lua_scripts'
`Source: "bin\lua_hilscher\gui_stuff.lua"; DestDir: "{app}\application\lua_hilscher"; Components: lua_scripts'
`Source: "bin\lua_hilscher\i18n.lua"; DestDir: "{app}\application\lua_hilscher"; Components: lua_scripts'
`Source: "bin\lua_hilscher\utils.lua"; DestDir: "{app}\application\lua_hilscher"; Components: lua_scripts'
`'
`'
`[Icons]'
