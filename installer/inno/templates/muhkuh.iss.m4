...
`[Setup]'
`AppName=Muhkuh'
`AppVersion="'__VERSION_MAJ__`.'__VERSION_MIN__`.'__VERSION_SUB__`"'
`AppVerName="Muhkuh '__VERSION_MAJ__`.'__VERSION_MIN__`.'__VERSION_SUB__`"'
`OutputBaseFilename=muhkuh_'__VERSION_MAJ__`.'__VERSION_MIN__`.'__VERSION_SUB_INT__`_setup'
`VersionInfoTextVersion="'__VERSION_MAJ__`.'__VERSION_MIN__`.'__VERSION_SUB__`"'
`VersionInfoVersion="'__VERSION_MAJ__`.'__VERSION_MIN__`.'__VERSION_SUB_INT__`"'
`'
