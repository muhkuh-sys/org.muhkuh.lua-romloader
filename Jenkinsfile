pipeline {
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: '*/Branch_v2.3.6']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'SubmoduleOption', disableSubmodules: false, recursiveSubmodules: true, reference: '', trackingSubmodules: false]], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/muhkuh-sys/org.muhkuh.lua-lua51-romloader.git']]])
            }
        }
        stage('Windows') {
            steps {
