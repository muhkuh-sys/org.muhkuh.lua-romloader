-- ---------------------------------------------------------------------------
-- ./_luaif/dpm_netx5_lua_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- ---------------------------------------------------------------------------
dpm_netx5_lua_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(dpm_netx5_lua_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(dpm_netx5_lua_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(dpm_netx5_lua_preprocConditionTable) do
