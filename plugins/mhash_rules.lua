-------------------------------------------------------------------------------
-- Rules to build the mhash bindings for wxLua
--  load using : $lua -e"rulesFilename=\"mhash_rules.lua\"" genwxbind.lua
-------------------------------------------------------------------------------
...
hook_cpp_header_filename = "mhash_wxlua_bindings.h"
...
hook_cpp_binding_post_includes = "#include \"application/mhash_lua_interface.h\""
