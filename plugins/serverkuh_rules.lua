-------------------------------------------------------------------------------
-- Rules to build the Muhkuh bindings for wxLua
--  load using : $lua -e"rulesFilename=\"muhkuh_rules.lua\"" genwxbind.lua
-------------------------------------------------------------------------------
...
hook_cpp_namespace = "serverkuh_lua"
...
hook_cpp_header_filename = "serverkuh_wxlua_bindings.h"
