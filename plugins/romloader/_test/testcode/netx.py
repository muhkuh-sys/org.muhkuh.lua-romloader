...
# Check if user provided a compiler prefix
  ...
  if ARGUMENTS.get('prefix'):
    ...
    prefix = '/home/Benten/Compile/crossgcc_4.2.2/bin/arm-elf-'
    #prefix = '/home/Benten/Coding/netx/arm-gcc-4.0.3/bin/arm-elf-'

  if(ARGUMENTS.get('libdir_netx500')):
    _library_includes_netx500 = ARGUMENTS.get('libdir_netx500')
  else:
    _library_includes_netx500 = ['/home/Benten/Coding/netx/arm-gcc-4.0.3/arm-elf/lib/interwork/arm926ej-s',
                               '/home/Benten/Coding/netx/arm-gcc-4.0.3/lib/gcc/arm-elf/4.0.3/interwork/arm926ej-s']

  if(ARGUMENTS.get('libdir_netx50')):
    _library_includes_netx50 = ARGUMENTS.get('libdir_netx50')
  else:
    _library_includes_netx50  = ['/home/Benten/Coding/netx/arm-gcc-4.0.3/arm-elf/lib/interwork/arm926ej-s',
                               '/home/Benten/Coding/netx/arm-gcc-4.0.3/lib/gcc/arm-elf/4.0.3/interwork/arm926ej-s']
...
arm_env.Decider('timestamp-match')
