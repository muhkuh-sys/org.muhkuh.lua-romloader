...
wxLuaBindDefine* wxLuaGetDefineList_romloader_usb_lua(size_t &count)
{
...
static wxLuaArgTag s_wxluatagArray_wxLua_function_romloader_usb_create[] = { &s_wxluaarg_Number, NULL };
...
static int LUACALL wxLua_function_romloader_usb_create(lua_State *L)
{
    ...
    returns = (romloader *)romloader_usb_create((void*)pvHandle);
...
static wxLuaBindCFunc s_wxluafunc_wxLua_function_romloader_usb_create[1] = {{ wxLua_function_romloader_usb_create, WXLUAMETHOD_CFUNCTION, 1, 1, s_wxluatagArray_wxLua_function_romloader_usb_create }};
...
// binding class
extern wxLuaBindClass  *wxLuaGetClassList_romloader_usb_lua(size_t &count);
extern wxLuaBindDefine *wxLuaGetDefineList_romloader_usb_lua(size_t &count);
extern wxLuaBindString *wxLuaGetStringList_romloader_usb_lua(size_t &count);
extern wxLuaBindEvent  *wxLuaGetEventList_romloader_usb_lua(size_t &count);
extern wxLuaBindObject *wxLuaGetObjectList_romloader_usb_lua(size_t &count);
extern wxLuaBindMethod *wxLuaGetFunctionList_romloader_usb_lua(size_t &count);
...
wxLuaBinding_romloader_usb_lua::wxLuaBinding_romloader_usb_lua() : wxLuaBinding()
{
    ...
    m_defineArray   = wxLuaGetDefineList_romloader_usb_lua(m_defineCount);
...
// bind wxLuaBinding_romloader_usb_lua to a single wxLuaState
bool wxLuaBinding_romloader_usb_lua_bind(const wxLuaState& wxlState_)
{
    ...
    wxASSERT(!wxlState.GetLuaBinding(wxT("romloader_usb_lua")));

    // ignore binding request when we already have romloader_usb_lua registered
    if (wxlState.GetLuaBinding(wxT("romloader_usb_lua")))
        return false;

    wxlState.GetLuaStateData()->m_bindingList.Append(new wxLuaBinding_romloader_usb_lua());

    return true;
}
// initialize wxLuaBinding_romloader_usb_lua for all wxLuaStates
