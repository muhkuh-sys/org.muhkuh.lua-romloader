-- ---------------------------------------------------------------------------
-- ./_luaif/romloader_usb_lua_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- typedefTable
-- ---------------------------------------------------------------------------
romloader_usb_lua_typedefTable =
{
  WXHANDLE = "void *",
...
-- dataTypes
-- ---------------------------------------------------------------------------
romloader_usb_lua_dataTypeTable =
{
  BOOL = {
    IsNumber = true,
    Name = "BOOL",
...
-- ---------------------------------------------------------------------------
romloader_usb_lua_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(romloader_usb_lua_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(romloader_usb_lua_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(romloader_usb_lua_preprocConditionTable) do
