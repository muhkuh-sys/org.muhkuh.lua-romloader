// ---------------------------------------------------------------------------
// romloader_usb_lua.h - headers and tags for wxLua binding
//
// This file was generated by genwxbind.lua 
// Any changes made to this file may be lost when file is regenerated
// ---------------------------------------------------------------------------

#ifndef __HOOK_WXLUA_romloader_usb_lua_H__
#define __HOOK_WXLUA_romloader_usb_lua_H__
...
// binding class
class wxLuaBinding_romloader_usb_lua : public wxLuaBinding
{
public:
    wxLuaBinding_romloader_usb_lua();
    virtual wxLuaBinding* Clone() const { return new wxLuaBinding_romloader_usb_lua; }
...
protected:
    ...
    DECLARE_DYNAMIC_CLASS(wxLuaBinding_romloader_usb_lua)
};


// bind wxLuaBinding_romloader_usb_lua to a single wxLuaState
extern WXLUA_NO_DLLIMPEXP bool wxLuaBinding_romloader_usb_lua_bind(const wxLuaState& wxlState);
// initialize wxLuaBinding_romloader_usb_lua for all wxLuaStates
extern WXLUA_NO_DLLIMPEXP bool wxLuaBinding_romloader_usb_lua_init();
...
#endif // __HOOK_WXLUA_romloader_usb_lua_H__
