-- ---------------------------------------------------------------------------
-- ./_luaif/romloader_uart_lua_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- typedefTable
-- ---------------------------------------------------------------------------
romloader_uart_lua_typedefTable =
{
  WXHANDLE = "void *",
...
-- dataTypes
-- ---------------------------------------------------------------------------
romloader_uart_lua_dataTypeTable =
{
  BOOL = {
    IsNumber = true,
    Name = "BOOL",
...
-- ---------------------------------------------------------------------------
romloader_uart_lua_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(romloader_uart_lua_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(romloader_uart_lua_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(romloader_uart_lua_preprocConditionTable) do
