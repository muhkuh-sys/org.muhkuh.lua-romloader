...
%luacode
{
	...
	table.insert(_G.__MUHKUH_PLUGINS, romloader_uart.romloader_uart_provider())
}
#endif
 ...
 */
%ignore romloader_uart_provider::ClaimInterface;
%ignore romloader_uart_provider::ReleaseInterface;
 ...
 */
%newobject romloader_uart_reference::Create;
