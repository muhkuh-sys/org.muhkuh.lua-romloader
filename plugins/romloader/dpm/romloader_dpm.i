...
%luacode
{
	...
	table.insert(_G.__MUHKUH_PLUGINS, romloader_dpm.romloader_dpm_provider())
}
#endif
 ...
 */
%ignore romloader_dpm_provider::ClaimInterface;
%ignore romloader_dpm_provider::ReleaseInterface;
 ...
 */
%newobject romloader_dpm_reference::Create;
