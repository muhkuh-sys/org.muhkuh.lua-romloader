...
romloader_eth::romloader_eth(const char *pcName, const char *pcTyp, romloader_eth_provider *ptProvider, const char *pcDeviceName)
 ...
 , m_ptEthDev(NULL)
{
	...
	m_ptEthDev = new romloader_eth_device_platform(pcDeviceName);
