// ---------------------------------------------------------------------------
// romloader_openocd_lua.h - headers and tags for wxLua binding
//
...
// binding class
class wxLuaBinding_romloader_openocd_lua : public wxLuaBinding
{
public:
    wxLuaBinding_romloader_openocd_lua();
    virtual wxLuaBinding* Clone() const { return new wxLuaBinding_romloader_openocd_lua; }
...
extern WXLUA_NO_DLLIMPEXP bool wxLuaBinding_romloader_openocd_lua_bind(const wxLuaState& wxlState);
