-------------------------------------------------------------------------------
-- Rules to build the bit bindings for wxLua
--  load using : $lua -e"rulesFilename=\"bit_rules.lua\"" genwxbind.lua
-------------------------------------------------------------------------------
...
hook_cpp_header_filename = "bit_wxlua_bindings.h"
...
hook_cpp_binding_post_includes = "#include \"application/bit_lua_interface.h\""
