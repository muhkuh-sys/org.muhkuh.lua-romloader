-- ---------------------------------------------------------------------------
-- ./_luaif/mhash_lua_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- ---------------------------------------------------------------------------
mhash_lua_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(mhash_lua_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(mhash_lua_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(mhash_lua_preprocConditionTable) do
