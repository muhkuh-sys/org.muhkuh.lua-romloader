-- ---------------------------------------------------------------------------
-- ./_luaif/bit_lua_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(bit_lua_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(bit_lua_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(bit_lua_preprocConditionTable) do
