-- ---------------------------------------------------------------------------
-- ./_luaif/serverkuh_lua_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- ---------------------------------------------------------------------------
serverkuh_lua_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(serverkuh_lua_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(serverkuh_lua_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(serverkuh_lua_preprocConditionTable) do
